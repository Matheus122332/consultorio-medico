        ...
        <div>
            <form id="criarConta" action="criarCnt.php" method="POST">
                <div class="campos">
                    ...
                    <input type="text" name="nome" id="nome" placeholder="Digite seu nome completo:" required value="<?= htmlspecialchars($_SESSION['nome'] ?? '') ?>">
                </div>
                <div class="campos">
                    <label for="email">Email:</label>
                    <input type="email" name="email" id="email" placeholder="Digite seu email:" required value="<?= htmlspecialchars($_SESSION['email'] ?? '') ?>">
                </div>
                <div class="campos">
                    <label for="idade">Idade:</label>
                    <input type="number" name="idade" id="idade" placeholder="Idade:" required value="<?= htmlspecialchars($_SESSION['idade'] ?? '') ?>">
                </div>
                <div class="campos">
                    <label for="fone">Telefone:</label>
                    <input type="tel" name="fone" id="fone" placeholder="Digite seu telefone:" required value="<?= htmlspecialchars($_SESSION['fone'] ?? '') ?>">
                </div>
                <div class="campos">
                    <label for="rg">RG:</label>
                    <input type="text" name="rg" id="rg" placeholder="Digite seu rg:" required value="<?= htmlspecialchars($_SESSION['rg'] ?? '') ?>">
                </div>
                <div class="campos">
                    <label for="cpf">CPF:</label>
                    <input type="text" name="cpf" id="cpf" placeholder="Digite seu cpf:" required value="<?= htmlspecialchars($_SESSION['cpf'] ?? '') ?>">
                </div>
                <div class="campos">
                ...
                <div class="campos">
                    ...
                    <input type="text" id="cep" name="cep" placeholder="Digite seu cep:" required value="<?= htmlspecialchars($_SESSION['cep'] ?? '') ?>" pattern="\d{5}-\d{3}" title="Formato esperado: 12345-678">
                </div>
                 <div class="campos">
                    <label for="cidade">Cidade:</label> 
                    <input type="text" id="cidade" name="cidade" placeholder="Digite sua cidade:" required value="<?= htmlspecialchars($_SESSION['cidade'] ?? '') ?>">
                </div> 
                <div class="campos">
                    <label for="rua">Rua:</label> 
                    <input type="text" id="rua" name="rua" placeholder="Digite sua rua:" required value="<?= htmlspecialchars($_SESSION['rua'] ?? '') ?>">
                </div>
                <div class="campos">
                    <label for="bairro">Bairro:</label> 
                    <input type="text" id="bairro" name="bairro" placeholder="Digite seu bairro:" required value="<?= htmlspecialchars($_SESSION['bairro'] ?? '') ?>"> 
                </div>
                <div class="campos">
                    <label for="numero-casa">Número da Casa:</label> 
                    <input type="text" id="numero-casa" name="numero-casa" placeholder="Digite numero-casa:" required value="<?= htmlspecialchars($_SESSION['numero-casa'] ?? '') ?>"> 
                </div>
                <div class="campos">
