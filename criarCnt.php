...
if ($result->num_rows > 0) {
   // Enviar a mensagem de erro de volta à página do formulário 
   $_SESSION['mensagemErro'] = "Erro: Já existe um registro com o mesmo email, RG ou CPF";
   header("Location: criarConta.php?erro="); 
   exit();
} else {
